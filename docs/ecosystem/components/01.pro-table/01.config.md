...
| formatValue          | 自定义单元格内容格式化                                                                                                  | `function` <Tip content="(value: unknown, scope: TableRenderParams<T>) => string \| number" />                                           | —                                                                                                |
...
| formatLabel          | 自定义表头内容格式化                                                                                                    | `function` <Tip content="(label: unknown, scope: TableRenderParams<T>) => string \| number" />                                           | —                                                                                                |
