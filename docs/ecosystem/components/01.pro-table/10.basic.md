...
## 表头列宽高调整 <Badge type="tip" text="v2.2.2" />

通过 `headerResize` 配置项开启表头列宽高大小调整。

当开启该功能后，无论 `border` 是否开启，表头列的宽高支持拖拽调整大小，请将鼠标放到每一列的右侧边框和底部边框进行体验。

::: demo
pro-table/basic/header-resize
:::
