...
- 经典风格：保留 [Teek Design Vue2](https://vue2-admin.youngkbt.cn/) 的经典标签栏
...
Teek 经历过很多这些缓存导致问题的场景，比如 Teek 发布了一个新版，修改了内容是配置、项目，但是因为用户的浏览器已经缓存了这些旧版内容，而新版用旧版的缓存导致出现了很多问题，因此 Teek 内置版本升级功能。
