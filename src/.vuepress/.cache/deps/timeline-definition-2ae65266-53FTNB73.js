...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/timeline-definition-2ae65266.js
var Y = function() {
...
`), S.debug("timeline", s.db);
  ...
  let y;
  l === "sandbox" && (y = At("#i" + t));
  const d = (l === "sandbox" ? At(y.nodes()[0].contentDocument.body) : At("body")).select("#" + t);
  d.append("g");
  ...
  S.debug("bounds", M), S2 && d.append("text").text(S2).attr("x", M.width / 2 - o).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), I = u ? b + v + 150 : v + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", o).attr("y1", I).attr("x2", M.width + 3 * o).attr("y2", I).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), Ug(
    void 0,
    d,
...
//# sourceMappingURL=timeline-definition-2ae65266-53FTNB73.js.map
