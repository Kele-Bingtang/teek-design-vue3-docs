...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/c4Diagram-80a4d5b6.js
var qt = function() {
...
var W = function() {
  ...
  function t(l2, n, a, s, i, u, d, y) {
    const { fontSize: p, fontFamily: C, fontWeight: T } = y, R = l2.split(Bn.lineBreakRegex);
...
function I(e, t, r, o, l2) {
  if (!t[e].width)
    if (r)
      t[e].text = L0(t[e].text, l2, o), t[e].textLines = t[e].text.split(Bn.lineBreakRegex).length, t[e].width = l2, t[e].height = E0(t[e].text, o);
    else {
      let n = t[e].text.split(Bn.lineBreakRegex);
      ...
      for (const s of n)
        t[e].width = Math.max(
          ir(s, o),
          t[e].width
        ), a = E0(s, o), t[e].height = t[e].height + a;
    }
}
...
var V0 = function(e, t, r, o) {
  ...
  d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * b.diagramMarginX).attr("y", p.starty + b.diagramMarginY), jg(i, T, S2, b.useMaxWidth);
  const L = d ? 60 : 0;
  i.attr(
    "viewBox",
...
//# sourceMappingURL=c4Diagram-80a4d5b6-3Y2CXVJN.js.map
