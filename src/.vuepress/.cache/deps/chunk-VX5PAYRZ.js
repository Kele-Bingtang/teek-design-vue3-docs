...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/createText-7fe61f7a.js
function It(n, r) {
...
function Ht(n) {
  ...
  function A(F) {
    if (F === null) {
      L(n.exit("chunkFlow"), true), y(0), n.consume(F);
      return;
    }
...
function Xt(n, r, t) {
  ...
  function D(d, P, R) {
    ...
    function N(z) {
      return d.enter("codeFencedFence"), d.enter("codeFencedFenceSequence"), S2(z);
    }
    function S2(z) {
      return z === p ? (d.consume(z), j++, S2) : j < c ? R(z) : (d.exit("codeFencedFenceSequence"), B(d, w, "whitespace")(z));
    }
    function w(z) {
...
function ut(n) {
  ...
  for (; ++t < n.length; ) {
    ...
    if (e[0] === "enter")
      e[1].contentType && (Object.assign(r, le(n, t)), t = r[t], p = true);
...
function dn(n, r) {
  ...
  return e;
  function e(u) {
    return C(u) ? (n.enter("lineEnding"), n.consume(u), n.exit("lineEnding"), t = true, e) : q(u) ? B(
      n,
      e,
...
function Ce(n, r, t) {
  ...
  function h(o) {
    return o === 33 ? (n.consume(o), x) : o === 47 ? (n.consume(o), k) : o === 63 ? (n.consume(o), u = 3, e.interrupt ? r : W) : tn(o) ? (n.consume(o), i = String.fromCharCode(o), l = true, A) : t(o);
  }
  function x(o) {
  ...
  function f(o) {
    return o === i.charCodeAt(a++) ? (n.consume(o), a === i.length ? e.interrupt ? r : S2 : f) : t(o);
  }
  function k(o) {
    return tn(o) ? (n.consume(o), i = String.fromCharCode(o), A) : t(o);
  }
  function A(o) {
    return o === null || o === 47 || o === 62 || Y(o) ? o !== 47 && l && Zn.includes(i.toLowerCase()) ? (u = 1, e.interrupt ? r(o) : S2(o)) : Se.includes(i.toLowerCase()) ? (u = 6, o === 47 ? (n.consume(o), L) : e.interrupt ? r(o) : S2(o)) : (u = 7, e.interrupt && !e.parser.lazy[e.now().line] ? t(o) : l ? _(o) : y(o)) : o === 45 || v(o) ? (n.consume(o), i += String.fromCharCode(o), A) : t(o);
  }
  function L(o) {
  ...
  function N(o) {
    return q(o) ? (n.consume(o), N) : o === null || C(o) ? S2(o) : t(o);
  }
  function S2(o) {
...
function Ie(n, r, t) {
  ...
  function N(s) {
    return s === 45 || v(s) ? (n.consume(s), N) : s === 47 || s === 62 || Y(s) ? S2(s) : t(s);
  }
  function S2(s) {
    return s === 47 ? (n.consume(s), H) : s === 58 || s === 95 || tn(s) ? (n.consume(s), w) : C(s) ? (a = S2, Q(s)) : q(s) ? (n.consume(s), S2) : H(s);
  }
  function w(s) {
    return s === 45 || s === 46 || s === 58 || s === 95 || v(s) ? (n.consume(s), w) : z(s);
  }
  function z(s) {
    return s === 61 ? (n.consume(s), U) : C(s) ? (a = z, Q(s)) : q(s) ? (n.consume(s), z) : S2(s);
  }
  function U(s) {
...
function Ze(n, r, t) {
  ...
  function i(a) {
    return e.containerState._closeFlow = true, e.interrupt = void 0, B(
      n,
      n.attempt($, r, t),
      "linePrefix",
      e.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4
...
function ur(n, r, t) {
  ...
  function x(S2) {
    return i = Z(i, S2), L(), i[i.length - 1] !== null ? [] : (R(r, 0), p.events = Bn(l, p.events, p), p.events);
  }
  function g(S2, w) {
    return ar(f(S2), w);
  }
  ...
  function _(S2) {
    C(S2) ? (e.line++, e.column = 1, e.offset += S2 === -3 ? 2 : 1, N()) : S2 !== -1 && (e.column++, e.offset++), e._bufferIndex < 0 ? e._index++ : (e._bufferIndex++, e._bufferIndex === i[e._index].length && (e._bufferIndex = -1, e._index++)), p.previous = S2;
  }
  function F(S2, w) {
    const z = w || {};
    return z.type = S2, z.start = k(), p.events.push(["enter", z, p]), a.push(z), z;
  }
  function O(S2) {
    const w = a.pop();
  ...
  function R(S2, w) {
    S2.resolveAll && !l.includes(S2) && l.push(S2), S2.resolve && en(
      p.events,
      w,
      p.events.length - w,
  ...
  function j() {
    const S2 = k(), w = p.previous, z = p.currentConstruct, U = p.events.length, G = Array.from(a);
    return {
      restore: nn,
      from: U
    };
    function nn() {
      e = S2, p.previous = w, p.currentConstruct = z, p.events.length = U, a = G, N();
    }
  }
  function N() {
...
var kr = Object.freeze(Object.defineProperty({
  __proto__: null,
  attentionMarkers: xr,
  contentInitial: sr,
  disable: gr,
...
var Sr = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
function Fr(n) {
  ...
  function(n, r, t) {
    return typeof r != "string" && (t = r, r = void 0), Er(t)(
      yr(
        ...
        dr(t).document().write(br()(n, r, true))
      )
    );
  }
);
function Er(n) {
  ...
  function u(m, b, E) {
    let I = b - 1, T = -1, X = false, an, rn, gn, kn;
    for (; ++I <= E; ) {
      const M = m[I];
      if (M[1].type === "listUnordered" || M[1].type === "listOrdered" || M[1].type === "blockQuote" ? (M[0] === "enter" ? T++ : T--, kn = void 0) : M[1].type === "lineEndingBlank" ? M[0] === "enter" && (an && !kn && !T && !gn && (gn = I), kn = void 0) : M[1].type === "linePrefix" || M[1].type === "listItemValue" || M[1].type === "listItemMarker" || M[1].type === "listItemPrefix" || M[1].type === "listItemPrefixWhitespace" || (kn = void 0), !T && M[0] === "enter" && M[1].type === "listItemPrefix" || T === -1 && M[0] === "exit" && (M[1].type === "listUnordered" || M[1].type === "listOrdered")) {
        ...
        }, m.splice(I, 0, ["enter", an, M[2]]), I++, E++, gn = void 0, kn = true);
      }
    }
  ...
  function s() {
    ...
    if (l("inReference", true), E.type === "link") {
      const I = m.children;
      E.children = I;
    } else
      E.alt = b;
  ...
  if (t.forEach((p) => {
    ...
    if (vn(l, 1.1, h) <= n)
      ...
      for (let A = 0; A <= h.length; A++)
        if (x = h.slice(f, A), S.info(x, f, A), vn(l, 1.1, x) > n) {
...
//# sourceMappingURL=chunk-VX5PAYRZ.js.map
