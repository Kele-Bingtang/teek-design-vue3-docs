...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/infoDiagram-8f094d68.js
var P = function() {
  var c = function(h, t, e, n) {
    ...
    parse: function(t) {
      var e = this, n = [0], s = [], r = [null], i = [], k = this.table, $ = "", b = 0, T = 0, z = 2, j = 1, D = i.slice.call(arguments, 1), o = Object.create(this.lexer), g = { yy: {} };
      for (var E in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, E) && (g.yy[E] = this.yy[E]);
      o.setInput(t, g.yy), g.yy.lexer = o, g.yy.parser = this, typeof o.yylloc > "u" && (o.yylloc = {});
      var w = o.yylloc;
      i.push(w);
      ...
      for (var l, _, a, I, m = {}, v, y, F, S2; ; ) {
        if (_ = n[n.length - 1], this.defaultActions[_] ? a = this.defaultActions[_] : ((l === null || typeof l > "u") && (l = Y()), a = k[_] && k[_][l]), typeof a > "u" || !a.length || !a[0]) {
          var A = "";
          S2 = [];
          for (v in k[_])
...
` + o.showPosition() + `
Expecting ` + S2.join(", ") + ", got '" + (this.terminals_[l] || l) + "'" : A = "Parse error on line " + (b + 1) + ": Unexpected " + (l == j ? "end of input" : "'" + (this.terminals_[l] || l) + "'"), this.parseError(A, {
            text: o.match,
        ...
        switch (a[0]) {
          case 1:
            n.push(l), r.push(o.yytext), i.push(o.yylloc), n.push(a[1]), l = null, T = o.yyleng, $ = o.yytext, b = o.yylineno, w = o.yylloc;
            break;
          case 2:
            if (y = this.productions_[a[1]][1], m.$ = r[r.length - y], m._$ = {
              ...
              return I;
            y && (n = n.slice(0, -1 * y * 2), r = r.slice(0, -1 * y), i = i.slice(0, -1 * y)), n.push(this.productions_[a[1]][0]), r.push(m.$), i.push(m._$), F = k[n[n.length - 2]][n[n.length - 1]], n.push(F);
            break;
          case 3:
            return true;
        }
...
` + c);
    const { securityLevel: x } = Ut();
    let p, h;
    x === "sandbox" && (p = At("#i" + f), h = p.nodes()[0].contentDocument);
    const e = (p !== void 0 && h !== void 0 && h !== null ? At(h) : At("body")).select("#" + f);
    ...
    S.error("error while rendering info diagram", x);
  }
};
var H = { draw: G };
var K = {
...
//# sourceMappingURL=infoDiagram-8f094d68-NSNUPEUT.js.map
