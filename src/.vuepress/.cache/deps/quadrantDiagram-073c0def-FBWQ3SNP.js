import {
  Un
} from "./chunk-OTAFN6GX.js";
import "./chunk-DTYHWPGT.js";
import {
  Aa,
  At,
  Ea,
...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/quadrantDiagram-073c0def.js
var qt = function() {
...
var Qt = class {
  ...
  getDefaultConfig() {
    ...
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: ((a = Yd.quadrantChart) == null ? void 0 : a.chartWidth) || 500,
      chartWidth: ((h = Yd.quadrantChart) == null ? void 0 : h.chartHeight) || 500,
      titlePadding: ((f = Yd.quadrantChart) == null ? void 0 : f.titlePadding) || 10,
      titleFontSize: ((g = Yd.quadrantChart) == null ? void 0 : g.titleFontSize) || 20,
      quadrantPadding: ((u = Yd.quadrantChart) == null ? void 0 : u.quadrantPadding) || 5,
      xAxisLabelPadding: ((c = Yd.quadrantChart) == null ? void 0 : c.xAxisLabelPadding) || 5,
      yAxisLabelPadding: ((p = Yd.quadrantChart) == null ? void 0 : p.yAxisLabelPadding) || 5,
      xAxisLabelFontSize: ((s = Yd.quadrantChart) == null ? void 0 : s.xAxisLabelFontSize) || 16,
      yAxisLabelFontSize: ((o = Yd.quadrantChart) == null ? void 0 : o.yAxisLabelFontSize) || 16,
      quadrantLabelFontSize: ((m = Yd.quadrantChart) == null ? void 0 : m.quadrantLabelFontSize) || 16,
      quadrantTextTopPadding: ((B = Yd.quadrantChart) == null ? void 0 : B.quadrantTextTopPadding) || 5,
      pointTextPadding: ((V = Yd.quadrantChart) == null ? void 0 : V.pointTextPadding) || 5,
      pointLabelFontSize: ((_ = Yd.quadrantChart) == null ? void 0 : _.pointLabelFontSize) || 12,
      pointRadius: ((D = Yd.quadrantChart) == null ? void 0 : D.pointRadius) || 5,
      xAxisPosition: ((b = Yd.quadrantChart) == null ? void 0 : b.xAxisPosition) || "top",
      yAxisPosition: ((H = Yd.quadrantChart) == null ? void 0 : H.yAxisPosition) || "left",
      quadrantInternalBorderStrokeWidth: ((G = Yd.quadrantChart) == null ? void 0 : G.quadrantInternalBorderStrokeWidth) || 1,
      quadrantExternalBorderStrokeWidth: ((Z = Yd.quadrantChart) == null ? void 0 : Z.quadrantExternalBorderStrokeWidth) || 2
    };
  }
  ...
  getQuadrantPoints(a) {
    const { quadrantSpace: h } = a, { quadrantHeight: f, quadrantLeft: g, quadrantTop: u, quadrantWidth: c } = h, p = Un().domain([0, 1]).range([g, c + g]), s = Un().domain([0, 1]).range([f + u, u]);
...
` + e);
  ...
  jg(B, D, _, ((T = p.quadrantChart) == null ? void 0 : T.useMaxWidth) || true), B.attr("viewBox", "0 0 " + _ + " " + D), f.db.setHeight(D), f.db.setWidth(_);
...
//# sourceMappingURL=quadrantDiagram-073c0def-FBWQ3SNP.js.map
