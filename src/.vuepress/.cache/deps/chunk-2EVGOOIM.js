...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/styles-be2d7003.js
var mt = function() {
...
var I = function(t, s = xt, n = null, h = null, u = null, f = null, p = null, v = null) {
  ...
  g.states[d] === void 0 ? (S.info("Adding state ", d, h), g.states[d] = {
    ...
    styles: [],
    textStyles: []
  }) : (g.states[d].doc || (g.states[d].doc = n), g.states[d].type || (g.states[d].type = s)), h && (S.info("Setting state description", d, h), typeof h == "string" && Et(d, h.trim()), typeof h == "object" && h.forEach((k) => Et(d, k.trim()))), u && (g.states[d].note = u, g.states[d].note.text = Bn.sanitizeText(
...
//# sourceMappingURL=chunk-2EVGOOIM.js.map
