...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.4/node_modules/mermaid/dist/requirementDiagram-9d898ddc.js
var he = function() {
...
var Et = function(e, t, a, c, d) {
  ...
  t.type == d.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + Bn.getUrl(y.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + Bn.getUrl(y.arrowMarkerAbsolute) + "#" + Ae.ReqMarkers.ARROW + "_line_ending)"
  )), gt(e, h, y, `<<${t.type}>>`);
};
var Rt = (e, t, a) => {
...
var kt = (e, t, a, c) => {
  ...
  jg(h, A2, v, y.useMaxWidth), h.attr("viewBox", `${T.x - S3} ${T.y - S3} ${v} ${A2}`);
};
var St = {
  draw: kt
};
...
//# sourceMappingURL=requirementDiagram-9d898ddc-LBG5QFJH.js.map
