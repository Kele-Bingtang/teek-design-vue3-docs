<template><div><nav class="table-of-contents"><ul><li><router-link to="#介绍">介绍</router-link></li><li><router-link to="#基本使用">基本使用</router-link><ul><li><router-link to="#get">get</router-link></li><li><router-link to="#其他">其他</router-link></li><li><router-link to="#完整写法">完整写法</router-link></li></ul></li><li><router-link to="#contenttype-封装">ContentType 封装</router-link></li><li><router-link to="#数组封装">数组封装</router-link></li><li><router-link to="#loading-封装">Loading 封装</router-link></li><li><router-link to="#映射封装">映射封装</router-link></li><li><router-link to="#请求异常封装">请求异常封装</router-link></li></ul></nav>
<h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2>
<p>Admin 基于 Axios 封装了一套开箱即用的 http 请求。在 <code v-pre>src/config/request</code> 目录下。</p>
<h4 id="中文文档" tabindex="-1"><a class="header-anchor" href="#中文文档" aria-hidden="true">#</a> 中文文档</h4>
<p><a href="https://www.axios-http.cn/" target="_blank" rel="noopener noreferrer">点击查看中文文档<ExternalLinkIcon/></a></p>
