...
│─ favicon.ico
│─ index.html
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同时 Admin 使用 <a href="http://postcss.org/" target="_blank" rel="noopener noreferrer">postcss<ExternalLinkIcon/></a> 压缩 css，使用 <a href="https://yiming_chang.gitee.io/pure-admin-doc/pages/tailwindcss/#autoprefixer" target="_blank" rel="noopener noreferrer">Autoprefixer<ExternalLinkIcon/></a> 自动添加浏览器前缀。</p>
</div></template>
