<template><div><nav class="table-of-contents"><ul><li><router-link to="#路由配置规则">路由配置规则</router-link></li><li><router-link to="#路由加载规则">路由加载规则</router-link><ul><li><router-link to="#异步懒加载">异步懒加载</router-link></li></ul></li><li><router-link to="#国际化">国际化</router-link><ul><li><router-link to="#非国际化">非国际化</router-link></li><li><router-link to="#国际化-1">国际化</router-link></li></ul></li><li><router-link to="#路由配置">路由配置</router-link><ul><li><router-link to="#标签页固定">标签页固定</router-link></li><li><router-link to="#路由缓存">路由缓存</router-link></li><li><router-link to="#菜单隐藏">菜单隐藏</router-link></li><li><router-link to="#菜单渲染-一个">菜单渲染（一个）</router-link></li><li><router-link to="#菜单渲染-多个">菜单渲染（多个）</router-link></li></ul></li><li><router-link to="#路由内置属性">路由内置属性</router-link><ul><li><router-link to="#meta-fullpath">meta._fullPath</router-link></li><li><router-link to="#meta-dynamic">meta._dynamic</router-link></li><li><router-link to="#redirect">redirect</router-link></li><li><router-link to="#component">component</router-link></li></ul></li><li><router-link to="#重置路由">重置路由</router-link></li><li><router-link to="#iframe-路由">IFrame 路由</router-link><ul><li><router-link to="#如何使用">如何使用？</router-link></li><li><router-link to="#iframe-加载">IFrame 加载</router-link></li><li><router-link to="#iframe-缓存">IFrame 缓存</router-link></li><li><router-link to="#iframe-新标签打开">IFrame 新标签打开</router-link></li><li><router-link to="#代码">代码</router-link></li></ul></li><li><router-link to="#外链路由">外链路由</router-link></li><li><router-link to="#路由权限">路由权限</router-link></li></ul></nav>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="路由配置" tabindex="-1"><a class="header-anchor" href="#路由配置" aria-hidden="true">#</a> 路由配置</h2>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>详细的内容请看：<RouterLink to="/advanced%20-%20auth.html">进阶 - 权限</RouterLink>。</p>
</div></template>
